...
// V2E : Search String is not highlighted in IE8
// Use Object detection instead of browser detection.As browser string is keeps changing from version to version.
...
function ShowPage (page,theframe,mot)
{
  ...
  {
    var loc = "CATIA_PLM_Express_OpenPage.htm?page=" + page + ";mots=" + mot;
